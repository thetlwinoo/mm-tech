...
import { BoxSidebarService } from './sidebar.service';
...
export class BoxSidebarComponent implements OnInit, OnDestroy {
    @Input()
    name: string;
    ...
    ngOnInit(): void {
        this._boxConfigService.config
            ...
            .subscribe((config) => {
                this._boxConfig = config;
            });

        this._boxSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._boxSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('box-sidebar-overlay');

        if (this.invisibleOverlay) {
            this._backdrop.classList.add('box-sidebar-overlay-invisible');
        }
